...
export function LoginCardWithForm() {
  ...
  return (
    <Card className="w-[350px] p">
      <CardHeader>
        <CardTitle className="text-xl text-center pb-2">Welcome back</CardTitle>
        ...
        <div className="pt-2 relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
